...
export const GCCSetup = () => {
  ...
  useEffect(() => {
    ...
    const cities = [
      ...
      { name: 'United States', angle: Math.PI * 0.8, distance: 450, visible: true, savings: 61, priority: 'high' },
      { name: 'Saudi Arabia', angle: Math.PI * 1.8, distance: 420, visible: true, savings: 59, priority: 'high' },
      { name: 'UAE (Dubai)', angle: Math.PI * 1.7, distance: 428, visible: true, savings: 54, priority: 'high' },
      { name: 'Norway', angle: Math.PI * 1.9, distance: 413, visible: true, savings: 51, priority: 'medium' },
      { name: 'Canada', angle: Math.PI * 1.5, distance: 428, visible: true, savings: 49, priority: 'medium' },
      { name: 'Australia', angle: Math.PI * 0.5, distance: 465, visible: true, savings: 49, priority: 'medium' },
      
      // Secondary markets that appear over time
      { name: 'Germany', angle: Math.PI * 0.1, distance: 420, visible: false, savings: 45, priority: 'medium' },
      { name: 'China', angle: Math.PI * 0.35, distance: 435, visible: false, savings: 30, priority: 'low' },
      { name: 'Brazil', angle: Math.PI * 1.3, distance: 458, visible: false, savings: 23, priority: 'low' },
      
      // Additional strategic markets
      { name: 'UK (London)', angle: Math.PI * 0.05, distance: 415, visible: false, savings: 52, priority: 'medium' },
      { name: 'Malaysia', angle: Math.PI * 0.4, distance: 440, visible: false, savings: 47, priority: 'medium' },
      { name: 'Singapore', angle: Math.PI * 0.42, distance: 438, visible: false, savings: 46, priority: 'medium' },
      { name: 'Kuwait', angle: Math.PI * 1.75, distance: 425, visible: false, savings: 53, priority: 'medium' },
      { name: 'Qatar', angle: Math.PI * 1.72, distance: 422, visible: false, savings: 52, priority: 'medium' },
      { name: 'Mexico', angle: Math.PI * 1.25, distance: 435, visible: false, savings: 41, priority: 'low' },
      { name: 'Nigeria', angle: Math.PI * 0.2, distance: 430, visible: false, savings: 38, priority: 'low' }
    ];
    ...
    const animate = () => {
      ...
      cities.forEach((city, index) => {
        ...
        const appearTime = city.priority === 'high' ? index * 0.8 : 
                          city.priority === 'medium' ? 4 + index * 0.5 : 
                          6.5 + index * 0.4;
        ...
        if (isVisible || city.visible) {
          ...
          const connectionAlpha = Math.min(1, Math.max(0, currentTime - appearTime) / 2);
  ...
  const transitionModels = {
    leasing: {
      ...
      description: "Start with 100% ScaleIQ workforce and gradually transition to client payroll over 3 years. This model eliminates hiring risks while building your team capability.",
      timeline: "36 months",
      phases: [
        {
          period: "Months 1-12",
          split: "100:0 (ScaleIQ : Client)",
          description: "Complete workforce on ScaleIQ payroll during setup and stabilization"
        },
        {
          period: "Months 13-24", 
          split: "70:30 (ScaleIQ : Client)",
          description: "Gradual transition begins with proven performers moving to client payroll"
        },
        {
          period: "Months 25-36",
          split: "30:70 (ScaleIQ : Client)",
          description: "Majority workforce on client payroll with ScaleIQ providing ongoing support"
        }
      ],
      benefits: [
    ...
    consulting: {
      ...
      description: "Comprehensive consulting services for GCC strategy, setup, and operations optimization with flexible engagement models.",
      timeline: "12-18 months",
      phases: [
        {
          period: "Months 1-3",
          split: "Strategy & Planning",
          description: "GCC strategy development, location analysis, and implementation roadmap"
        },
        {
          period: "Months 4-12",
          split: "Setup & Implementation", 
          description: "End-to-end GCC establishment including infrastructure, team building, and processes"
        },
        {
          period: "Months 13-18",
          split: "Optimization & Handover",
          description: "Operations optimization, performance improvement, and knowledge transfer"
        }
      ],
      benefits: [
  ...
  const whyIndia = [
    {
      ...
      description: "Significant operational cost reduction compared to onshore operations",
      stats: "Average savings of $50K-80K per FTE annually"
    },
    {
      icon: Users,
      title: "World-Class Talent Pool",
      description: "Access to highly skilled engineers with energy domain expertise",
    ...
    },
    {
      ...
      stats: "12.5 hour time difference with Houston enables continuous operations"
    },
    {
      icon: Globe,
  ...
  const successMetrics = [
    { metric: "Setup Time", value: "4-6 Months", description: "From decision to operational GCC" },
    { metric: "Cost Reduction", value: "60-70%", description: "Compared to onshore operations" },
    { metric: "Talent Retention", value: "90%+", description: "Industry-leading retention rates" },
    { metric: "Productivity Gain", value: "25-40%", description: "Within first 12 months" }
  ];
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-8 text-center">
          <div className="flex items-center justify-center space-x-3 text-[#255073] mb-6">
            ...
            <span className="text-lg font-medium tracking-wide">INDIA GCC SETUP</span>
            <div className="w-12 h-0.5 bg-[#255073]" />
          </div>
          <h1 className="text-4xl lg:text-5xl font-bold text-black mb-6">
            Accelerate Your <span className="text-[#255073]">India GCC Journey</span>
          </h1>
          <p className="text-xl text-black/70 max-w-3xl mx-auto mb-8">
            From strategy to operations, we provide end-to-end India GCC setup services with zero-risk workforce models and proven implementation expertise.
          </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {successMetrics.map((item, index) => (
                  <div key={index} className="text-center">
                    <div className="text-3xl font-bold text-[#255073] mb-2">{item.value}</div>
                    <div className="text-black font-medium mb-1">{item.metric}</div>
                    <div className="text-black/60 text-sm">{item.description}</div>
                  </div>
                ))}
              </div>
            </Card>
            ...
            <div className="space-y-8">
              <div>
                <div className="flex items-center justify-center lg:justify-start space-x-3 text-[#255073] mb-6">
                  <div className="w-12 h-0.5 bg-[#255073]" />
                  <span className="text-lg font-medium tracking-wide">GLOBAL OPERATIONS</span>
                  <div className="w-12 h-0.5 bg-[#255073]" />
                </div>
                ...
                <p className="text-xl text-black/70 text-center lg:text-left">
                  Real-world cost savings achieved by global energy companies through India GCC operations
                </p>
              </div>
              ...
              <div className="space-y-4">
                {[
                  { region: "United States", savings: "61%", color: "bg-red-500" },
                  { region: "Saudi Arabia", savings: "59%", color: "bg-orange-500" },
                  { region: "UAE (Dubai)", savings: "54%", color: "bg-yellow-500" },
                  { region: "Norway", savings: "51%", color: "bg-green-500" },
                  { region: "Canada", savings: "49%", color: "bg-blue-500" },
                  { region: "Australia", savings: "49%", color: "bg-purple-500" }
                ].map((item, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-white/80 rounded-lg border border-gray-200">
                    <div className="flex items-center space-x-3">
                      <div className={`w-3 h-3 ${item.color} rounded-full`}></div>
                      <span className="font-medium text-black">{item.region}</span>
                    </div>
                    <span className="text-[#255073] font-bold">{item.savings}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="bg-white/90 p-6 rounded-lg border border-gray-200">
                <h4 className="font-semibold text-black mb-4">Visualization Guide</h4>
            ...
            <div className="relative h-[500px] lg:h-[700px] xl:h-[800px] flex items-center justify-center">
              ...
              <div className="relative w-full h-full flex flex-col items-center justify-center">
                ...
                <div className="text-center mt-6">
                  <h3 className="text-xl lg:text-2xl font-bold text-black mb-2">Global Operations Connected to India GCC</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-black mb-6">
              End-to-End <span className="text-[#255073]">GCC Establishment</span>
            </h2>
            <p className="text-xl text-black/70 max-w-2xl mx-auto">
              Complete support from initial planning to fully operational GCC with ongoing optimization
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {gccServices.map((service, index) => {
              ...
              return (
                <Card key={index} className={`bg-gradient-to-br ${service.gradient} border-black/10 hover:border-[#255073]/30 transition-all duration-300 p-8`}>
                  <div className="flex items-start space-x-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#255073] font-medium mb-4">{service.description}</p>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-black mb-6">
              Flexible <span className="text-[#255073]">Partnership Models</span>
            </h2>
            <p className="text-xl text-black/70 max-w-2xl mx-auto">
              Choose the engagement model that best fits your risk tolerance and business objectives
            </p>
          </div>
          ...
          <Card className="bg-gradient-to-br from-[#255073]/10 to-transparent border-[#255073]/20 p-8 mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Timeline */}
              <div>
                <h4 className="text-lg font-bold text-black mb-4">Implementation Timeline</h4>
                <div className="space-y-4">
                  {transitionModels[activeModel].phases.map((phase, index) => (
                    <Card key={index} className="bg-white border-black/10 p-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-semibold text-black">{phase.period}</span>
              ...
              {/* Benefits */}
              <div>
                <h4 className="text-lg font-bold text-black mb-4">Key Benefits</h4>
                <div className="space-y-3">
                  {transitionModels[activeModel].benefits.map((benefit, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-black mb-6">
              Strategic Advantages of <span className="text-[#255073]">India Operations</span>
            </h2>
            <p className="text-xl text-black/70 max-w-2xl mx-auto">
              ...
              return (
                <Card key={index} className="bg-white border-black/10 hover:border-[#255073]/30 transition-all duration-300 p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-black mb-2">{advantage.title}</h3>
                      <p className="text-black/70 mb-3">{advantage.description}</p>
                      <p className="text-[#255073] text-sm font-medium">{advantage.stats}</p>
                    </div>
                  </div>
                </Card>
              );
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-black mb-6">
              Typical GCC <span className="text-[#255073]">Implementation Timeline</span>
            </h2>
            <p className="text-black/70 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { phase: "Phase 1", duration: "Month 1", title: "Strategy & Planning", activities: ["GCC Strategy", "Location Analysis", "Legal Setup", "Compliance Framework"] },
              { phase: "Phase 2", duration: "Months 2-3", title: "Infrastructure Setup", activities: ["Office Setup", "IT Infrastructure", "Security Systems", "Communication Tools"] },
              { phase: "Phase 3", duration: "Months 4-5", title: "Team Building", activities: ["Talent Acquisition", "Onboarding Programs", "Process Training", "Quality Systems"] },
              { phase: "Phase 4", duration: "Month 6+", title: "Operations & Scale", activities: ["Live Operations", "Performance Monitoring", "Continuous Improvement", "Scaling Plans"] }
            ].map((phase, index) => (
              <Card key={index} className="bg-white border-black/10 p-6 text-center relative">
                ...
                <div className="mb-2">
                  <span className="text-[#255073] text-sm font-medium">{phase.phase}</span>
                  <span className="text-black/60 text-sm"> • {phase.duration}</span>
                </div>
                <h3 className="text-lg font-bold text-black mb-3">{phase.title}</h3>
      ...
      <section className="py-16 bg-gradient-to-r from-[#255073]/10 via-[#255073]/5 to-[#255073]/10">
        <div className="max-w-7xl mx-auto px-8 text-center">
          ...
          <p className="text-black/70 mb-8 max-w-2xl mx-auto">
            Start your India GCC journey with zero risk and proven expertise. Let's discuss your specific requirements.
          </p>
          <Button 
